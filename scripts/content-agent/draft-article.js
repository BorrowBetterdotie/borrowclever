...
const DRAFT_TOOL = {
  ...
  input_schema: {
    type: 'object',
    required: ['title', 'slug', 'metaDescription', 'bodyHtml', 'tags'],
    properties: {
      ...
      tags: {
        ...
        minItems: 2,
        maxItems: 5,
        description: 'Short topic tags covering the article\'s main themes, e.g. ["ECB", "Interest Rates", "Cost of Living"]. Used for meta keywords, JSON-LD, and visible tag chips.',
      },
    },
  },
};
...
async function main() {
  ...
  if (!Array.isArray(draft.tags) || draft.tags.length === 0 || !draft.tags.every((t) => typeof t === 'string' && t)) {
    throw new Error('Draft is missing required field: tags (non-empty array of strings)');
  }
  ...
  updateNewsIndex(REPO_ROOT, { dateIso, title: draft.title, slug: draft.slug, metaDescription: draft.metaDescription, tags: draft.tags });
