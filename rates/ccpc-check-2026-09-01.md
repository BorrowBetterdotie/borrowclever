# CCPC cross-check — 2026-09-01

Secondary rate verification against CCPC's public loan comparison tool (compare.ccpc.ie), alongside the lender-scraper snapshot (`rates/rates-2026-09-01.csv`).
