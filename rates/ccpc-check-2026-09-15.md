# CCPC cross-check — 2026-09-15

Secondary rate verification against CCPC's public loan comparison tool (compare.ccpc.ie), alongside the lender-scraper snapshot (`rates/rates-2026-09-15.csv`).

18 of 20 rows need attention.
